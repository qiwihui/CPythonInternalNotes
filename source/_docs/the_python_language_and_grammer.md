...
![coffee_statement](images/the_python_language_and_grammer/coffee_statement.png)
...
![with_stmt](images/the_python_language_and_grammer/with_stmt.png)
...
![try_stmt](images/the_python_language_and_grammer/try_stmt.png)
...
![decorator_DFA](images/the_python_language_and_grammer/decorator_DFA.png)

NFA 和 DFA 图仅用于调试复杂语法的设计。

我们将使用铁路图代替 DFA 或 NFA 图来表示语法。例如，此图表示 `decorator` 语句可以采用的路径：

![decorator_stmt](images/the_python_language_and_grammer/decorator_stmt.png)
...
![pass_stmt](images/the_python_language_and_grammer/pass_stmt.png)
...
![pass_stmt_modified](images/the_python_language_and_grammer/pass_stmt_modified.png)
...
![namedexpr_test](images/the_python_language_and_grammer/namedexpr_test.png)
...
![if_stmt_namedexpr_test](images/the_python_language_and_grammer/if_stmt_with_namedexpr_test.png)
